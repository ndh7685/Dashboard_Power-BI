...
# Hàm dự đoán gian lận với độ tuổi từ 0 đến 70
def predict_fraud_age_range(start_age=0, end_age=70, insured_sex='MALE'):
    results = []
    for age in range(start_age, end_age + 1):
        ...
        results.append({'Age': age, 'Insured Sex': insured_sex, 'Fraud Probability': fraud_prob})

    return pd.DataFrame(results)

# Gọi hàm để dự đoán cho độ tuổi từ 0 đến 70 với giới tính cụ thể
fraud_age_male = predict_fraud_age_range(insured_sex='MALE')
fraud_age_female = predict_fraud_age_range(insured_sex='FEMALE')

# Kết quả dự đoán cho nam
print("Predicted Fraud Probability for Males:")
print(fraud_age_male)

# Kết quả dự đoán cho nữ
print("Predicted Fraud Probability for Females:")
print(fraud_age_female)
